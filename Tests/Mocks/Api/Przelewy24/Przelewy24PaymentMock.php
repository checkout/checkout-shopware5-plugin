...
namespace CkoCheckoutPayment\Tests\Mocks\Api\Przelewy24;

use Checkout\Library\Exceptions\CheckoutException;
use Checkout\Models\Payments\IdSource;
use Checkout\Models\Payments\Payment;

class Przelewy24PaymentMock
{
    /**
     * @var bool
     */
    ...
    public function request()
    {
        if ($this->shouldThrowApiException) {
            throw new CheckoutException(Przelewy24PaymentMock::class);
        }
        ...
        $payment->_links = [
            ...
            'redirect' => [
                'href' => 'https://r3.girogate.de/ti/simp24'
            ]
        ];
