// {namespace name="backend/cko_setup/controller/credit_card"}
// {block name="backend/cko_setup/controller/credit_card"}
Ext.define('Shopware.apps.CkoSetup.controller.CreditCard', {
    extend: 'Enlight.app.Controller',
    refs: [
        { ref: 'configurationTab', selector: 'cko-setup-credit-card-configuration' },
        { ref: 'topToolbar', selector: 'cko-setup-top-toolbar' }
    ],

    shopId: null,

    loadConfigurationUrl: '{url controller="CkoSetupCreditCard" action="loadConfiguration" module=backend}',
    ...
    registerCustomEventListeners: function () {
        ...
        me.control({
            ...
            'cko-setup-credit-card-configuration': {
    ...
    loadConfiguration: function (shopId) {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                me.configurationRecord = Ext.create('Shopware.apps.CkoSetup.model.CreditCard.Configuration', decodedResponse.configuration);
