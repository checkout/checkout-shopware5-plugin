// {namespace name="backend/cko_setup/controller/sofort"}
// {block name="backend/cko_setup/controller/sofort"}
Ext.define('Shopware.apps.CkoSetup.controller.Sofort', {
    extend: 'Enlight.app.Controller',
    refs: [
        { ref: 'configurationTab', selector: 'cko-setup-sofort-configuration' },
        { ref: 'topToolbar', selector: 'cko-setup-top-toolbar' }
    ],

    shopId: null,

    loadConfigurationUrl: '{url controller="CkoSetupSofort" action="loadConfiguration" module=backend}',
    ...
    registerCustomEventListeners: function () {
        ...
        me.control({
            ...
            'cko-setup-sofort-configuration': {
    ...
    loadConfiguration: function (shopId) {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                me.configurationRecord = Ext.create('Shopware.apps.CkoSetup.model.Sofort.Configuration', decodedResponse.configuration);
