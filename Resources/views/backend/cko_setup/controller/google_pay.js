// {namespace name="backend/cko_setup/controller/google_pay"}
// {block name="backend/cko_setup/controller/google_pay"}
Ext.define('Shopware.apps.CkoSetup.controller.GooglePay', {
    extend: 'Enlight.app.Controller',
    refs: [
        { ref: 'configurationTab', selector: 'cko-setup-google-pay-configuration' },
        { ref: 'topToolbar', selector: 'cko-setup-top-toolbar' }
    ],

    shopId: null,

    loadConfigurationUrl: '{url controller="CkoSetupGooglePay" action="loadConfiguration" module=backend}',
    ...
    registerCustomEventListeners: function () {
        ...
        me.control({
            ...
            'cko-setup-google-pay-configuration': {
    ...
    loadConfiguration: function (shopId) {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                me.configurationRecord = Ext.create('Shopware.apps.CkoSetup.model.GooglePay.Configuration', decodedResponse.configuration);
