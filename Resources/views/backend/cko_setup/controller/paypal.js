// {namespace name="backend/cko_setup/controller/paypal"}
// {block name="backend/cko_setup/controller/paypal"}
Ext.define('Shopware.apps.CkoSetup.controller.Paypal', {
    extend: 'Enlight.app.Controller',
    refs: [
        { ref: 'configurationTab', selector: 'cko-setup-paypal-configuration' },
        { ref: 'topToolbar', selector: 'cko-setup-top-toolbar' }
    ],

    shopId: null,

    loadConfigurationUrl: '{url controller="CkoSetupPayPal" action="loadConfiguration" module=backend}',
    ...
    registerCustomEventListeners: function () {
        ...
        me.control({
            ...
            'cko-setup-paypal-configuration': {
    ...
    loadConfiguration: function (shopId) {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                me.configurationRecord = Ext.create('Shopware.apps.CkoSetup.model.Paypal.Configuration', decodedResponse.configuration);
