...
class PaymentMethodValidatorCompilerPass implements CompilerPassInterface
{
    private const DEFINITION_NAME = 'cko_checkout_payment.components.payment_method_validator.payment_method_validator_service';
